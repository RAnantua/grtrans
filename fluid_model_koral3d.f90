...
!   -- modified from fluid_model_harm.f90
   module fluid_model_koral3d
      ...
      contains
        ...
        character(len=250), intent(in) :: ifile
        ...
        character(len=250), intent(in) :: data_file
        ...
        character(len=250), intent(in), optional :: ifile
        character(len=250) :: default_ifile='koral.in' !AC
        character(len=250), intent(in), optional :: df,hf
