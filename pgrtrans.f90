       ...
       contains
          ...
          subroutine grtrans_main(standard,mumin,mumax,nmu,phi0,spin,&
            ...
            fbl06,fnp,ftp,frin,frout,fthin,fthout,fphiin,fphiout,epcoefindx,epotherargs,nepotherargs,fscalefac,sigcut)
...
!INPUTS=====================
            ...
            character(len=250), intent(in) :: ename,fname,iname,stype,outfile
...
! FLUID ARGUMENTS
            character(len=250), intent(in) :: fdfile,fhfile,fgfile,fsim
